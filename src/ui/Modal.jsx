  ...
  return createPortal(
    ...
    <div className="fixed left-0 top-0 z-[999] min-h-full min-w-full bg-text-color/10 backdrop-blur-[2px] transition-all duration-[0.5s]">
      ...
      <div
        ref={ref}
        // h-full
        className="fixed left-1/2 top-1/2 flex  w-full translate-x-[-50%] translate-y-[-50%] items-center justify-center overflow-hidden overflow-y-scroll rounded-lg bg-primary-background px-16 pb-5  sm:max-h-[80%] sm:w-auto sm:min-w-[500px]"
      >
