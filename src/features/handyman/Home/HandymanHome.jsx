...
export default function HandymanHome() {
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-10">
        ...
        <div className="flex min-w-80 items-center gap-5 rounded-lg bg-secondary-background px-6 py-4 shadow-md">
          ...
          <div className=" space-y-2">
            ...
            <div className="text-large font-bold tracking-wider">{`3.9`}</div>
          </div>
        </div>
        <div className="flex min-w-80 items-center gap-5 rounded-lg bg-secondary-background px-6 py-4 shadow-md">
          ...
          <div className=" space-y-2">
            ...
            <div className="text-large font-bold tracking-wider">{`5`}</div>
          </div>
        </div>
        <div className="flex min-w-80 items-center gap-5 rounded-lg bg-secondary-background px-6 py-4 shadow-md">
          ...
          <div className=" space-y-2">
            ...
            <div className=" text-large font-semibold tracking-wider">{`5`}</div>
          </div>
        </div>
      </div>
            ...
            <div className="pt-6">
              ...
              <div className="max-h-[483px] space-y-5 overflow-scroll">
                ...
                <div className=" w-full space-y-5 overflow-hidden rounded-lg bg-secondary-background px-6 py-4">
                  ...
                  {/* <p className=" line-clamp-3 text-xsmall">
              أود أن أطلب صندوقًا متحركًا لتخزين الأدوات والمستلزمات في مكتبي.
              يجب أن يكون الصندوق مصنوعًا من الخشب عالي الجودة ويحتوي على عجلات
              قابلة للتحرك لسهولة التنقل. يجب أن يكون الصندوق مزودًا بعدة أدراج
              مختلفة الأحجام لتنظيم الأغراض بشكل فعال. يفضل أن يكون التصميم
  ...
  //       </div>
  //     </div>
  //     <div className=" grid md:gap-12 gap-10 lg:grid-cols-[repeat(2,1fr)]">
  //       {/* المهام الجديده */}
  //       <div className=" relative space-y-5 rounded-lg border border-text-color/20 px-6 pb-6 pt-4">
  //         <span className=" absolute top-0 mx-[-4px] translate-y-[-50%] cursor-pointer bg-primary-background px-[4px] text-medium font-semibold">
  //           المهام الجديده
  //         </span>
  //         <div className=" space-y-5 overflow-hidden rounded-lg bg-secondary-background px-6 py-4">
  ...
  //             {
  //               title: "صيانة باب",
  //               date: formatDate(sub(Date.now(), { days: 3 }), "yyyy-MM-dd"),
  //             },
  //             {
  //               title: "صيانة مكتب",
  //               date: formatDate(add(Date.now(), { days: 3 }), "yyyy-MM-dd"),
  //             },
  //             {
  //               title: "تركيب عَجل لمكتب خشبي",
  //               date: formatDate(add(Date.now(), { days: 6 }), "yyyy-MM-dd"),
  //             },
  //             {
  //               title: "تصنيع وحدة ادراج",
  //               date: formatDate(add(Date.now(), { days: 12 }), "yyyy-MM-dd"),
  //             },
  //             {
  //               title: "تصنيع وحدة ادراج",
  //               date: formatDate(add(Date.now(), { days: 14 }), "yyyy-MM-dd"),
  //             },
  //             {
  //               title: "تصنيع وحدة ادراج",
  //               date: formatDate(add(Date.now(), { days: 18 }), "yyyy-MM-dd"),
  //             },
  //             {
  //               title: "تصنيع وحدة ادراج",
  //               date: formatDate(add(Date.now(), { days: 22 }), "yyyy-MM-dd"),
  //             },
  //           ]}
  //         />
  //       </div>
  ...
  //           <Tooltip />
  //           <Legend iconType="line" />
  //           <Line type="monotone" dataKey="المهام المكتملة" stroke="#82ca9d" />
  //         </LineChart>
  //       </ResponsiveContainer>
  //     </div>
  //   </div>
